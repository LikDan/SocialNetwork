...
namespace  { 
             ...
             * @static 
             */ 
            public static function paginateBy($params, $desc = false, $byColumn = 'id', $defaultPerPage = 20)
            {
                                return \Illuminate\Database\Eloquent\Builder::paginateBy($params, $desc, $byColumn, $defaultPerPage);
            }
